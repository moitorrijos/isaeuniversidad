...
function create_ofertaacadmica_cpt() {
	...
	$labels = array(
		...
		'menu_name' => _x( 'Ofertas Académicas', 'Admin Menu text', 'isaeuniversidad' ),
		...
		'all_items' => __( 'Todas las Ofertas Académicas', 'isaeuniversidad' ),
		...
		'view_items' => __( 'Ver Ofertas Académicas', 'isaeuniversidad' ),
		'search_items' => __( 'Buscar Oferta Académica', 'isaeuniversidad' ),
		'not_found' => __( 'No se encontraron Ofertas Académicas.', 'isaeuniversidad' ),
		...
		'items_list' => __( 'Lista de Ofertas Académicas', 'isaeuniversidad' ),
		'items_list_navigation' => __( 'Navegación por el listado de Ofertas Académicas', 'isaeuniversidad' ),
		'filter_items_list' => __( 'Lista de Ofertas Académicas filtradas', 'isaeuniversidad' ),
	);
	$args = array(
